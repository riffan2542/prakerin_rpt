				...
				<nav class="main-menu">
					<ul class="nav metismenu">
						<li class="nav-dropdown active">
							<a class="has-arrow" href="#" aria-expanded="false"><i class="icon dripicons-browser"></i><span>MyVG Web</span></a>
                        </li>
                        <li class="nav-dropdown">
							<a class="has-arrow" aria-expanded="false"><i class="icon dripicons-blog"></i><span>Data Artikel</span></a>
							<ul class="collapse nav-sub" aria-expanded="false">
								<li><a href="/admin/artikel"><span>Artikel</span></a></li>
                                <li><a href="/admin/kategori"><span>Kategori Artikel</span></a></li>
					...
					<ul class="navbar-nav nav-right">
						...
						<li class="nav-item dropdown">
							<a class="nav-link nav-pill user-avatar" data-toggle="dropdown" href="#" role="button" aria-haspopup="true" aria-expanded="false">
								<img src="/backend/assets/img/avatars/fotopp.jpg" class="w-35 rounded-circle">
							</a>
							<div class="dropdown-menu dropdown-menu-right dropdown-menu-accout">
								<div class="dropdown-header pb-3">
									<div class="media d-user">
										<img class="align-self-center mr-3 w-40 rounded-circle" src="/backend/assets/img/avatars/fotopp.jpg">
								...
								<a class="dropdown-item" href="pages.profile.html"><i class="icon dripicons-user"></i>Profil</a>
								<a class="dropdown-item" href="pages.my-account.html"><i class="icon dripicons-gear"></i>Pengaturan Akun</a>
								<div class="dropdown-divider"></div>
								<a class="dropdown-item" href="{{ route('logout') }}" onclick="event.preventDefault();
                                document.getElementById('logout-form').submit();">
                                <i class="icon dripicons-lock-open"></i> {{ __('Keluar') }}</a>

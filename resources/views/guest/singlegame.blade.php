                                ...
                                <ul>
                                    ...
                                    <li><a href="#">Pages</a>
                                        <ul class="dropdown">
                                            ...
                                            <li><a href="/singlepost">Single Articles</a></li>
                                            <li><a href="/gamereview">Game Review</a></li>
                                            <li><a href="/singlegame">Single Game Review</a></li>
                        ...
                        <div id="gameSlides" class="carousel slide" data-ride="carousel">
                            <div class="carousel-inner">
                                <div class="carousel-item active">
                                    <img class="d-block w-100" src="{{ asset('template/egames/img/bg-img/35.jpg') }}" alt="">
                                </div>
                                <div class="carousel-item">
                                    <img class="d-block w-100" src="{{ asset('template/egames/img/bg-img/36.jpg') }}" alt="">
                                </div>
                                <div class="carousel-item">
                                    <img class="d-block w-100" src="{{ asset('template/egames/img/bg-img/37.jpg') }}" alt="">
                                </div>
                                <div class="carousel-item">
                                    <img class="d-block w-100" src="{{ asset('template/egames/img/bg-img/38.jpg') }}" alt="">
                                </div>
                                <div class="carousel-item">
                                    <img class="d-block w-100" src="{{ asset('template/egames/img/bg-img/39.jpg') }}" alt="">
                                </div>
                                <div class="carousel-item">
                                    <img class="d-block w-100" src="{{ asset('template/egames/img/bg-img/40.jpg') }}" alt="">
                                </div>
                            </div>
                            <ol class="carousel-indicators">
                                <li data-target="#gameSlides" data-slide-to="0" class="active" style="background-image: url(template/egames/img/bg-img/35.jpg);"></li>
                                <li data-target="#gameSlides" data-slide-to="1" style="background-image: url(template/egames/img/bg-img/36.jpg);"></li>
                                <li data-target="#gameSlides" data-slide-to="2" style="background-image: url(template/egames/img/bg-img/37.jpg);"></li>
                                <li data-target="#gameSlides" data-slide-to="3" style="background-image: url(template/egames/img/bg-img/38.jpg);"></li>
                                <li data-target="#gameSlides" data-slide-to="4" style="background-image: url(template/egames/img/bg-img/39.jpg);"></li>
                                <li data-target="#gameSlides" data-slide-to="5" style="background-image: url(template/egames/img/bg-img/40.jpg);"></li>
                            </ol>
                        </div>
                    </div>
                </div>
